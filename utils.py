...
# select the right data from the grouped data-frame
...
def read_data_(session, use_x0, param):
    """
    The main function to read the data
    :param session: session's data to be read
    :param use_x0: to whether use x0 instead of U as the VMS
    :param param: parameters of the session (important for the decompression)
    :return: read data-frame with the columns : 'stim' / 'subject' / 'category' / 'parsimony' / 'feature'
    """
    for file in os.listdir(session):
